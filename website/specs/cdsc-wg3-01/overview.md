...
This is a summary overview of [`cdsc-wg3-01`]({{ "/specs/cdsc-wg3-01" | relative_url }}), which
...
[`cdsc-wg1-02`](https://connectivity.carbondataspec.org/specs/cdsc-wg1-02), which allows Clients to register with
    ...
    "eacs": [
        {
            ...
            "values": [
                ...
                ... # 31 entries total (one for each 1-day generation segment)
            ],
        },
        ...
    ],
